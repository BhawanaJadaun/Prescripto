...
const changeAvailablitiy = async (req, res) => {
  try {
...
export { changeAvailablitiy, doctorList, loginDoctor,appointmentsDoctor,appointmentCancel,appointmentComplete,doctorDashboard,doctorProfile,updateDoctorProfile };
